...
# 数据库
# ============================================================
DB_PATH = os.environ.get("STOCK_DB_PATH", os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "stock.db"))
...
SNAPSHOT_ARCHIVE_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "archive")
